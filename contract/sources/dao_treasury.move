module fibre::dao_treasury {
    ...
    public fun deposit_coin(dao: &mut Dao, payment: &mut Coin<SUI>, amount: u64, ctx: &mut TxContext) {
    ...
    public fun withdraw_coin(dao: &mut Dao, reciever: address, amount: u64, ctx: &mut TxContext) {
